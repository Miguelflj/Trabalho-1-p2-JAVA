...
public class porDia extends JFrame {
	...
	public porDia(Lista lcl,Lista lca,Lista lal,String codAluguel,String placa,int cpf,DevolveCarro dc) {
		...
		nomeFrame = new JLabel("Cobrança por Dia");
			...
			if(aux == calcula) {
				...
				while(auxt != null) {
					...
					if( placa.equals(ca.getPlaca()) ) {
						...
						divida =  ca.getTaxa_dia() * ( periodo.getDays() + ( periodo.toTotalMonths() * 30 ) ); 
